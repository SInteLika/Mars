    ...
    return (
        <div className={'features'}>
            ...
            <div className="features__img">
                <img src="/images/features/title.png" alt=""/>
            </div>
            <div className="features-list">
                ...
                <div className="features-list-item-wrapper">
                    <div className="features-list-item features-list-item_red">
                        <img src="/images/features/trade.png" alt="" className="features-list-item__img"/>
                    ...
                    <img src="/images/features/orange1.png" alt="" className="features-list-item__orange2"/>
                </div>
            </div>
